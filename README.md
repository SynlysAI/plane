...
| 项目             | 内容                                                                                                                                                                                                                                                                                                                                 |
| ---------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 当前版本         | `4.12.0`（根 / `apps/web` / `apps/api` / 全部 workspace package 同步）                                                                                                                                                                                                                                                               |
| 上游基线         | Plane `1.4.x`                                                                                                                                                                                                                                                                                                                        |
| 已交付           | 科研管理 P0（`2.1.0`）、阶段流程与集成 P1（`2.2.0`）、科研测试夹具（`2.3.0`）、系统管理改进（`2.4.0`）、科研目录分级可见（`2.5.0`）、演示组织树单链化（`2.5.1`）、科研智能平台 Phase 0、Phase 1 UI/UX 工作台（`4.9.0`）、科研工作台产品级 UI/UX 重构（`4.10.0`）、信息架构精炼（`4.11.0`）、产品级 UI 精细化与信息可视化（`4.12.0`） |
