...
class ResearchErrorCode:
    ...
    ACCOUNT_LINK_NOT_FOUND = "ACCOUNT_LINK_NOT_FOUND"
    ACCOUNT_LINK_VERIFICATION_INVALID = "ACCOUNT_LINK_VERIFICATION_INVALID"
    AGENT_SESSION_NOT_FOUND = "AGENT_SESSION_NOT_FOUND"
    AGENT_SCOPE_INVALID = "AGENT_SCOPE_INVALID"
    AGENT_UPSTREAM_NOT_CONFIGURED = "AGENT_UPSTREAM_NOT_CONFIGURED"
    KB_NOT_READY = "KB_NOT_READY"
    KB_SCOPE_CONFLICT = "KB_SCOPE_CONFLICT"
    KB_GROUP_UNASSIGNED = "KB_GROUP_UNASSIGNED"
    KB_REQUEST_NOT_FOUND = "KB_REQUEST_NOT_FOUND"
    KB_BINDING_CONFLICT = "KB_BINDING_CONFLICT"
