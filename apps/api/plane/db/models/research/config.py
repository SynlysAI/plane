...
class WorkspaceResearchSetting(BaseModel):
    ...
    research_chain_enabled = models.BooleanField(default=False)
    research_agent_enabled = models.BooleanField(default=False)
    ...
    research_ia_v2 = models.BooleanField(default=True)
