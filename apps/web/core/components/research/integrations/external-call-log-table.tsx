    ...
    <Table>
      <TableHeader>
        <TableRow className="text-tertiary">
          ...
          <TableHead>{t("research.integrations.columns.latency")}</TableHead>
          <TableHead>{t("research.integrations.columns.error")}</TableHead>
          <TableHead>{t("research.integrations.columns.time")}</TableHead>
        </TableRow>
      </TableHeader>
      <TableBody>
        {logs.map((log) => (
          <TableRow key={log.id}>
            ...
            <TableCell className="text-tertiary">{log.latency_ms ?? "-"}</TableCell>
            <TableCell className="text-tertiary">{log.error_code || "-"}</TableCell>
            <TableCell className="text-tertiary">{new Date(log.created_at).toLocaleString()}</TableCell>
          </TableRow>
        ))}
      </TableBody>
    </Table>
