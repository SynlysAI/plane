...
| 文档版本 | v1.4                                                                                                                                                   |
| 日期     | 2026-09-18                                                                                                                                             |
| 历史对应版本 | `3.0.3`；当前代码版本 `4.15.0`，本文仍是组织、权限和 Context 的当前契约                                                                                                                                                |
...
| 文档版本 | 日期       | 变更摘要                                                                                                                                         |
| -------- | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| v1.4     | 2026-09-24 | 4.10.0：科研工作台呈现层重构收敛到 Plane 设计系统（状态字典、Tabs、表格、空态与共享壳），业务契约、权限与 API 不变；见 UI/UX 重构 PRD 与验收报告 |
