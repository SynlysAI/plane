...
> 当前事实（2026-09-26）：Plane `develop` 代码版本为 `4.15.1`。Phase 1.5 已落地能力投影、节点上下文、KB `READY` 门禁、成果附件、实验外部资产入口、Agent OWNER/REVIEW scope、workflow 响应式布局、多课题切换和 π-Lab 真实基线重建。首个真实课题的浏览器证据以及双方 OIDC 认证仍是灰度出口条件。
