...
> 当前代码事实：`develop` 分支，软件版本 `4.16.0`。本文档按代码、测试和运行证据整理，更新时间：2026-09-26。
...
| 状态     | 含义                                    | 当前文档口径                                                              |
| -------- | --------------------------------------- | ------------------------------------------------------------------------- |
| 已交付   | 代码、自动化测试和发布/验收证据均已具备 | P0、P1、智能平台 Phase 0、Phase 1、Phase 1.5 代码修复与 `4.16.0` 兼容发布 |
...
3. 版本号与根 `package.json`、各应用/包和 API `pyproject.toml` 同步；当前软件版本为 `4.16.0`，文档版本独立维护。
